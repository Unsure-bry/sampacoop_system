        ...
        <Card>
          ...
          <div className="p-6">
            <div className="grid grid-cols-2 gap-4">
              <button 
                onClick={() => router.push('/admin/treasurer/loans')}
                className="flex flex-col items-center justify-center p-4 border rounded-lg hover:bg-gray-50"
              >
                <FileText className="h-8 w-8 text-red-600 mb-2" />
                <span className="text-sm font-medium">Loan Manager</span>
              </button>
              <button 
                onClick={() => router.push('/admin/treasurer/savings')}
                className="flex flex-col items-center justify-center p-4 border rounded-lg hover:bg-gray-50"
              >
              ...
              <button 
                onClick={() => router.push('/admin/treasurer/reports')}
                className="flex flex-col items-center justify-center p-4 border rounded-lg hover:bg-gray-50"
              >
